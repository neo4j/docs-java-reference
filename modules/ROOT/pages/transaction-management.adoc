...
[TIP]
====
The full source code used for the code snippet can be found at link:https://github.com/neo4j/neo4j-documentation/blob/{neo4j-version}/embedded-examples/src/main/java/org/neo4j/examples/TransactionEventListenerExample.java[TransactionEventListenerExample.java^].
====
