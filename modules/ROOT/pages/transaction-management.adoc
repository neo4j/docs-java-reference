...
:org-neo4j-helpers-TransactionTemplate: {neo4j-javadocs-base-uri}/org/neo4j/helpers/TransactionTemplate.html
...
[TIP]
====
The full source code used for the code snippet can be found at link:https://github.com/neo4j/neo4j-documentation/blob/{neo4j-version}/kernel/src/test/java/examples/DeadlockDocTest.java[DeadlockDocTest.java^].
====
...
======
If you do not want to write all the code yourself, there is a class called link:{org-neo4j-helpers-TransactionTemplate}[`org.neo4j.helpers.TransactionTemplate`^] that will help you achieve what is needed.
...
//https://github.com/neo4j/neo4j-documentation/blob/3.5/kernel/src/test/java/examples/DeadlockDocTest.java
