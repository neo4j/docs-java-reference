...
== When to use the Traversal Framework
The Traversal Framework offers a powerful approach to traversing the graph. Being able to dynamically make custom choices at each step
of the traversal makes it more expressive than Cypher and potentially more performant. The Traversal Framework also gives access to the full
power of the programming language to express these decisions.
