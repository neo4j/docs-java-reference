...
For a description of the monitoring options, see link:{neo4j-docs-base-uri}/operations-manual/4.2/monitoring/[Neo4j Operations Manual -> Monitoring].
...
Beans that duplicate metrics or monitoring options, described in link:{neo4j-docs-base-uri}/operations-manual/4.2/monitoring/[Neo4j Operations Manual -> Monitoring], have been removed.
====
...
To enable this feature, you need to enable JMX Remote Management and also configure JMX for secure remote access, in the link:{neo4j-docs-base-uri}/operations-manual/4.2/configuration/neo4j-conf/[_conf/neo4j.conf_ file].
