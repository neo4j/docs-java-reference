...
For a description of the monitoring options, see xref:4.0@operations-manual:ROOT:monitoring/index.adoc[Neo4j Operations Manual -> Monitoring].
...
Beans that duplicate metrics or monitoring options, described in xref:4.0@operations-manual:ROOT:monitoring/index.adoc[Neo4j Operations Manual -> Monitoring], have been removed.
====
...
To enable this feature, you need to enable JMX Remote Management and also configure JMX for secure remote access, in the xref:4.0@operations-manual:ROOT:configuration/neo4j-conf/index.adoc[_conf/neo4j.conf_ file].
