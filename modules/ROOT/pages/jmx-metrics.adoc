...
For a description of the monitoring options, see link:{neo4j-docs-base-uri}/operations-manual/3.5/monitoring[Neo4j Operations Manual -> Monitoring].
...
Beans that duplicate metrics or monitoring options, described in link:{neo4j-docs-base-uri}/operations-manual/3.5/monitoring[Neo4j Operations Manual -> Monitoring], will be removed.
====
...
For configuration details, see link:{neo4j-docs-base-uri}/operations-manual/3.5/reference/configuration-settings[Neo4j Operations Manual -> Configuration settings].
