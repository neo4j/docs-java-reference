...
Neo4j's Transactional Cypher HTTP endpoint (see link:{neo4j-docs-base-uri}/http-api/3.5/actions/[HTTP API Docs -> transactional Cypher endpoint]) streams responses back to the client.
