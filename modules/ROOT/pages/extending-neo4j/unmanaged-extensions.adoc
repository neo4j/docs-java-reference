...
Neo4j's Transactional Cypher HTTP endpoint (see xref:4.1@http-api:ROOT:actions/index.adoc[HTTP API Docs -> transactional Cypher endpoint]) streams responses back to the client.
