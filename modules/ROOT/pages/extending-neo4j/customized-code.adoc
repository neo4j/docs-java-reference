...
For the location of the _plugins_ directory, refer to link:{neo4j-docs-base-uri}/operations-manual/4.2/configuration/file-locations/[Operations Manual -> File locations].
...
The available built-in procedures varies depending edition and mode, as described in link:{neo4j-docs-base-uri}/operations-manual/4.2/reference/procedures/[Operations Manual -> Procedures].
...
The built-in functions are described in link:{neo4j-docs-base-uri}/cypher-manual/4.2/functions/[Cypher Manual -> Functions].
