...
:procedure-template-url: https://github.com/neo4j-examples/neo4j-procedure-template/tree/4.4
...
All functions are annotated with `@UserFunction` and return a single value.
...
For full details, see the documentation in link:{neo4j-docs-base-uri}/cypher-manual/4.4/clauses/call[Cypher Manual -> `CALL` procedure].
