...
:procedure-template-url: https://github.com/neo4j-examples/neo4j-procedure-template/tree/5.x
...
[NOTE]
====
The example uses JUnit 5, which requires the use of `org.neo4j.harness.junit.extension.Neo4jExtension`.
...
The following is an example of a user-defined procedure that returns the relationship types going in and out of a node:
...
For more information about Neo4j and Cypher versioning, see link:https://neo4j.com/docs/operations-manual/5/introduction/#_cypher_versions[Operations manual -> Introduction].
====
...
The following table shows the reserved procedure namespaces:
...
The following table shows the reserved function namespaces:
