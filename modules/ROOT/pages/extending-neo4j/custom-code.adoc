...
For the location of the _plugins_ directory, refer to xref:4.0@operations-manual:ROOT:configuration/file-locations/index.adoc[Operations Manual -> File locations].
...
The available built-in procedures varies depending edition and mode, as described in xref:4.0@operations-manual:ROOT:reference/procedures/index.adoc[Operations Manual -> Procedures].
...
The built-in functions are described in xref:4.0@cypher-manual:ROOT:functions/index.adoc[Cypher Manual -> Functions].
