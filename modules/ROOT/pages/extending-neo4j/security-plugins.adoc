...
Customized-built plugins have access to the link:{neo4j-docs-base-uri}/operations-manual/4.1/configuration/file-locations/[_<neo4j-home>_] directory in case you want to load any customized settings from a file located there.
