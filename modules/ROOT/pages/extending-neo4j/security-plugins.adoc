...
Custom-built plugins have access to the xref:4.0@operations-manual:ROOT:configuration/file-locations/index.adoc[_<neo4j-home>_] directory in case you want to load any custom settings from a file located there.
