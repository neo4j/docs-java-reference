...
Customized-built plugins have access to the xref:3.5@operations-manual:ROOT:configuration/file-locations/index.adoc[_<neo4j-home>_] directory in case you want to load any customized settings from a file located there.
