...
Read more about this config setting in link:{neo4j-docs-base-uri}/operations-manual/4.4/security/securing-extensions/[Operations Manual -> Securing extensions].
