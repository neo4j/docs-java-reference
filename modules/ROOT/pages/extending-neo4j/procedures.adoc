...
For full details, see the documentation in xref:4.3@cypher-manual:ROOT:clauses/call/index.adoc[Cypher Manual -> `CALL` procedure].
...
Read more about this config setting in xref:4.3@operations-manual:ROOT:security/securing-extensions/index.adoc[Operations Manual -> Securing extensions].
