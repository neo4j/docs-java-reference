...
For full details, see the documentation in link:{neo4j-docs-base-uri}/cypher-manual/4.1/clauses/call/[Cypher Manual -> `CALL` procedure].
...
Read more about this config setting in link:{neo4j-docs-base-uri}/operations-manual/4.1/security/securing-extensions/[Operations Manual -> Securing extensions].
