...
For full details, see the documentation in xref:4.0@cypher-manual:ROOT:clauses/call/index.adoc[Cypher Manual -> `CALL` procedure].
...
Read more about this config setting in xref:4.0@operations-manual:ROOT:security/securing-extensions/index.adoc[Operations Manual -> Securing extensions].
