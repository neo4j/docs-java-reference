...
If you want to use JUnit 4 with Neo4j 4.x, use `org.neo4j.harness.junit.rule.Neo4jRule` instead.
====

If you use junit4 -> 
If you use junit5 -> org.neo4j.harness.junit.extension.Neo4jExtension
