...
The _input_ and _output_ to and from a procedure or a function must be one of the supported types, as described in xref:4.4@cypher-manual:ROOT:syntax/values/index.adoc[Cypher Manual -> Values and types].
