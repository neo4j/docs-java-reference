...
Refer to the link:{neo4j-docs-base-uri}/operations-manual/4.2/security/securing-extensions/[Operations Manual -> Securing Extensions] for details on best practices for securing user-defined procedures and functions.
