...
[TIP]
====
The example described in this section is available link:https://github.com/neo4j-examples/neo4j-procedure-template/tree/3.5[on GitHub (neo4j-examples/neo4j-procedure-template)^].
====
