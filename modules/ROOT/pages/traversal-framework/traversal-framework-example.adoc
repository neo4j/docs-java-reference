...
This example shows how to implement a xref:extending-neo4j/user-defined-procedures-functions.adoc[user-defined procedure] using the Traversal Framework.
