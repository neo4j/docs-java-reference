...
To see other useful evaluators, check the xref:/docs/java-reference/{neo4j-version}/traversal-framework/traversal-framework-java-api/#traversal-java-api-evaluator[`org.neo4j.graphdb.traversal.Evaluators`^] Java API or simply implement the  xref:/docs/java-reference/{neo4j-version}/traversal-framework/traversal-framework-java-api/#traversal-java-api-evaluator[`org.neo4j.graphdb.traversal.Evaluator`^] interface yourself.
