:description: The Neo4j Traversal Framework Example.
...
== Example
Below is an example of how to implement a procedure using the Traversal Framework. This allows the Traversal Framework
to be used side by side with Cypher. The transaction and logger are made available through the Procedure Framework.
