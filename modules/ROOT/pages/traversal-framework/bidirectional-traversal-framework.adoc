...
The Bidirectional Traversal Framework allows the description of such a traversal with the xref:traversal-framework/bidirectional-traversal-framework.adoc#_defining_the_bidirectional_traverser[`BidirectionalTraversalDescription`].
