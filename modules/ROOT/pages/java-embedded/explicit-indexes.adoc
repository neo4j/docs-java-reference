...
Please see link:https://neo4j.com/docs/cypher-manual/3.5/schema/index/#schema-index-fulltext-search[Cypher Manual -> Indexes to support full-text search] to learn about using full-text schema indexes instead.
====
