...
In Java, you can use the link:{neo4j-docs-base-uri}/cypher-manual/4.0/[Cypher query language] as per the example below.
...
For more information and examples for Cypher, see link:{neo4j-docs-base-uri}/cypher-manual/4.0/[Neo4j Cypher Manual].
