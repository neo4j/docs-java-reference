...
In Java, you can use the xref:4.4@cypher-manual:ROOT:index.adoc[Cypher query language] as per the example below.
...
For more information and examples for Cypher, see xref:4.4@cypher-manual:ROOT:index.adoc[Neo4j Cypher Manual].
