...
For maintainability purposes, you can define your embedded DBMS configuration in the xref:3.5@operations-manual:ROOT:configuration/neo4j-conf/index.adoc[_neo4j.conf_] file as follows:
