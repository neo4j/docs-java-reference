...
See link:{neo4j-docs-base-uri}/operations-manual/4.1/introduction/[Operations Manual -> Introduction] for details about the Community and Enterprise Editions.
====
...
For maintainability purposes, you can define your embedded DBMS configuration in the link:{neo4j-docs-base-uri}/operations-manual/4.1/configuration/neo4j-conf/[_neo4j.conf_] file as follows:
