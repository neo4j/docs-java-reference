...
See xref:4.4@operations-manual:ROOT:introduction/index.adoc[Operations Manual -> Introduction] for details about the Community and Enterprise Editions.
====
...
For maintainability purposes, you can define your embedded DBMS configuration in the xref:4.4@operations-manual:ROOT:configuration/neo4j-conf/index.adoc[_neo4j.conf_] file as follows:
