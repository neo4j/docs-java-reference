...
See link:{neo4j-docs-base-uri}/operations-manual/3.5/introduction[Operations Manual -> Introduction] for details about the Community and Enterprise Editions.
====
